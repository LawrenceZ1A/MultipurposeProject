...
print("keep on firing, scream, surrender, roll over and play dead, start talking about orbital mechanics")
print("just copy the thing that you want and paste it")
do=input(">").lower()
if do== "keep on firing":
    print("You ran out of thing to fire")
    print("what do you want to do?")
    print("whack with the end of the firing tool, surrender, commit seppuku, beg to open peace talks")
    do=input(">").lower()
    if do=="whack with the end of the firing tool":
        print("ouch! they all get a concussion")
        print("what do you do?")
        print("use the bazooka, banzai charge, run around in circles")
        do=input(">").lower()
    ...
    if do=="sing the ussr national anthem":
        ...
        print("What do you do?")
        print("follow them ,stay where you are, wander into the forest")
        do=input(">").lower()
        if do=="follow them":
        ...
        print("what do you do?")
        print("laugh, say sorry, keep screaming")
        do=input(">").lower()
        if do=="laugh":
    ...
    print("what do you want to do?")
    print("call cuboid, be sad with everyone else, fart loudly")
    do=input(">").lower()
    if do=="call cuboid":
    ...
    print("what do you want to do?")
    print("ambush people, keep on playing dead")
    do=input(">").lower()
    if do=="ambush people":
    ...
    print("what do you want to do?")
    print("call the great lawrence, start a nasa fan club")
    do=input(">").lower()
    if do=="call the great lawrence":
        ...
        print("what do you do?")
        print("call cuboid, call enackerboi, call foolishmortal")
        do=input(">").lower()
        if do=="call cuboid":
            ...
            print("what do you do?")
            print("stop the fight, let the fight happened")
            do=input(">").lower()
